...
export const users: User[] = [
  currentUser,
  {
    id: "u-2",
    name: "Priya Kapoor",
    email: "priya@yognito.com",
    role: "Manager",
    avatar: avatar("Priya Kapoor"),
  ...
  },
  {
    id: "u-6",
    name: "Aisha Patel",
    email: "aisha@yognito.com",
    role: "Developer",
    avatar: avatar("Aisha Patel"),
  ...
  },
  {
    id: "u-7",
    name: "Liam O'Connor",
    email: "liam@yognito.com",
    role: "Developer",
    avatar: avatar("Liam O'Connor"),
    title: "QA Engineer",
    team: "Quality",
    status: "offline",
  },
  {
    id: "u-8",
    name: "Naomi Tanaka",
    email: "naomi@yognito.com",
    role: "Developer",
    avatar: avatar("Naomi Tanaka"),
    title: "UI Engineer",
    team: "Design Eng",
    status: "online",
  },
  {
    id: "u-9",
    name: "Ethan Wright",
    email: "ethan@yognito.com",
    role: "Employee",
    avatar: avatar("Ethan Wright"),
  ...
  },
  {
    id: "u-10",
    name: "Chloe Dubois",
    email: "chloe@yognito.com",
    role: "Employee",
    avatar: avatar("Chloe Dubois"),
  ...
  },
  {
    id: "u-12",
    name: "Hannah Schmidt",
    email: "hannah@yognito.com",
    role: "Developer",
    avatar: avatar("Hannah Schmidt"),
    title: "Data Engineer",
    team: "Data",
    status: "online",
  },
...
export const projects: Project[] = [
  {
    ...
    spent: 312000,
    lead: "u-2",
    members: ["u-4", "u-5", "u-7", "u-8"],
    tags: ["Web", "React", "B2B"],
  },
  {
    id: "p-2",
    key: "ORION",
    name: "Orion Billing Platform",
    client: "Helios Finance",
    status: "At Risk",
    priority: "Critical",
    progress: 54,
    ...
    spent: 520000,
    lead: "u-3",
    members: ["u-5", "u-6", "u-9", "u-12"],
    tags: ["FinTech", "Payments"],
  },
  {
    id: "p-3",
    key: "NEBULA",
    name: "Nebula Analytics Suite",
    client: "Internal",
    status: "On Track",
    priority: "Medium",
    progress: 41,
    ...
    spent: 148000,
    lead: "u-2",
    members: ["u-6", "u-8", "u-12"],
    tags: ["Analytics", "Data"],
  },
  {
    id: "p-4",
    key: "VELA",
    name: "Vela Mobile Banking",
    client: "First Meridian Bank",
    status: "Delayed",
    priority: "High",
    progress: 38,
...
export const sprints: Sprint[] = [
  {
    id: "s-23",
    name: "ATLAS Sprint 23",
    goal: "Ship checkout v2 + 3 critical bug fixes",
  ...
  {
    id: "s-22",
    name: "ATLAS Sprint 22",
    goal: "Account settings revamp",
  ...
  {
    id: "s-21",
    name: "ATLAS Sprint 21",
    goal: "Notifications overhaul",
  ...
  {
    id: "s-24",
    name: "ATLAS Sprint 24",
    goal: "Performance + Lighthouse 95+",
...
export const notifications = [
  {
    id: "n-1",
    title: "Priya assigned you ATLAS-128",
    desc: "Refactor checkout state machine",
    time: "2m ago",
    unread: true,
    type: "task",
  },
  {
    id: "n-2",
    title: "Sprint 23 burndown updated",
    desc: "5 issues remaining · 4 days left",
    time: "27m ago",
    unread: true,
    type: "sprint",
  },
  {
    id: "n-3",
    title: "Daniel commented on ORION-451",
    desc: '"Approving — let\'s ship after QA pass."',
    time: "1h ago",
    unread: true,
    type: "comment",
  },
  {
    ...
    desc: "atlas-web @ v2.14.0 → production",
    time: "3h ago",
    unread: false,
    type: "deploy",
  },
  {
    ...
    desc: "Platform team velocity up 12%",
    time: "Yesterday",
    unread: false,
    type: "report",
  },
