...
export function StatCard({
  ...
  return (
    ...
    >
      <div
        className={`absolute -top-10 -right-10 h-32 w-32 rounded-full bg-gradient-to-br ${tones[tone]} blur-2xl opacity-60`}
      />
      <div className="relative">
        <div className="flex items-start justify-between">
          ...
          <div
            className={`h-8 w-8 grid place-items-center rounded-lg bg-gradient-to-br ${tones[tone]}`}
          >
        ...
        <div className="mt-2 flex items-center gap-1.5 text-xs">
          <span
            className={`inline-flex items-center gap-0.5 font-semibold ${positive ? "text-[oklch(0.55_0.16_155)]" : "text-destructive"}`}
          >
            {positive ? (
