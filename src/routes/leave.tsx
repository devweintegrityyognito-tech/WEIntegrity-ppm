                  ...
                  <td className="px-5 py-3 text-right">
                    {r.status === "Pending" ? (
                      <div className="flex justify-end gap-1.5">
                        <button className="h-7 px-2.5 rounded-md text-xs font-medium bg-[oklch(0.95_0.04_155)] text-[oklch(0.4_0.14_155)] hover:opacity-90">
                          Approve
                        </button>
                        <button className="h-7 px-2.5 rounded-md text-xs font-medium bg-muted hover:bg-muted/70">
                          Reject
                        </button>
                      </div>
                    ) : (
